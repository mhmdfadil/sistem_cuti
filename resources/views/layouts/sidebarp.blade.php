<aside class="bg-custom text-light shadow-lg rounded-3" style="width: 350px;">
    <div class="p-4">
        ...
        <div class="d-flex align-items-center mb-4">
            <i class="bi bi-house-door-fill text-light me-3 fs-4"></i>
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center text-light rounded-lg {{ request()->is('pegawai/dashboard') ? 'active' : '' }}" href="{{ route('pegawai.dashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center text-light rounded-lg {{ request()->is('pegawai/biodata') ? 'active' : '' }}" href="{{ route('pegawai.biodata') }}">
                    <i class="bi bi-person-lines-fill me-3"></i>
                    <span>Biodata</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center text-light rounded-lg {{ request()->is('pegawai/pengajuan') ? 'active' : '' }}" href="{{ route('pegawai.pengajuan') }}">
                    <i class="bi bi-file-earmark-check-fill me-3"></i>
                    <span>Pengajuan Cuti</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center text-light rounded-lg {{ request()->is('pegawai/riwayat') ? 'active' : '' }}" href="{{ route('pegawai.riwayat') }}">
                    <i class="bi bi-archive-fill me-3"></i>
                    <span>Riwayat Pengajuan Cuti</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center text-light rounded-lg {{ request()->is('pegawai/profil') ? 'active' : '' }}" href="{{ route('pegawai.profil') }}">
