    ...
    <div class="quick-list mt-4">
        <div class="row">
            <div class="col-md-3 mb-4">
                <div class="card quick-card shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Lihat semua pengajuan Pegawai</p>
                        <a href="{{ route('admin.pengajuan') }}" class="btn btn-primary btn-sm">Lihat Data</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 mb-4">
                <div class="card quick-card shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Kelola semua akun</p>
                        <a href="{{ route('admin.akun') }}" class="btn btn-primary btn-sm">Lihat Akun</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 mb-4">
                <div class="card quick-card shadow-sm">
                    <div class="card-body text-center">
                        <i class="bi bi-person-badge quick-icon"></i>
                        <h5 class="card-title">Data Pegawai</h5>
                        <p class="card-text">Lihat data Pegawai</p>
                        <a href="{{ route('admin.pegawai') }}" class="btn btn-primary btn-sm">Lihat Pegawai</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 mb-4">
                <div class="card quick-card shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <a href="{{ route('admin.profil') }}" class="btn btn-primary btn-sm">Lihat Profil</a>
                    </div>
                </div>
            </div>
        </div>
